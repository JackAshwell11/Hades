...
void bind_components(pybind11::class_<Registry> &registry_class) {
  // TODO: https://chat.openai.com/c/32bf754e-b234-4d72-a008-48e5c83c1622
  (registry_class.def("add_component", &Registry::add_component<T>, pybind11::arg("game_object_id"), (
      ...
      "Raises:\n"
      "    RegistryException: If the game object is not registered or if the game object already has the component."
  )), ...);
  (registry_class.def("get_component", &Registry::get_component<T>, pybind11::arg("game_object_id"), (
      ...
      "    game_object_id: The game object ID.\n\n"
      "Raises:\n"
      "    RegistryException: If the game object is not registered or if the game object does not have the component.\n\n"
      "Returns:\n"
...
PYBIND11_MODULE(hades_extensions, m) {
  ...
  pybind11::module game_objects = m.def_submodule("game_objects",
                                                  "Contains the registry and the various components and systems that can be used with it.");
  pybind11::module
      systems = game_objects.def_submodule("systems", "Contains the systems which manage the game objects.");
  ...
  pybind11::class_<KinematicObject>(game_objects,
                                    "KinematicObject",
  ...
  pybind11::class_<Registry>
      registry_class(game_objects, "Registry", "Manages game objects, components, and systems that are registered.");
  registry_class.def(pybind11::init<>(), "Initialise the object.")
      ...
      .def("has_component",
           &Registry::has_component,
           pybind11::arg("game_object_id"),
           pybind11::arg("component_type"),
           (
      ...
      .def("get_kinematic_object", &Registry::get_kinematic_object, pybind11::arg("game_object_id"), (
          ...
          "    game_object_id: The game object ID.\n\n"
          "Raises:\n"
          "    RegistryException: If the game object is not registered or if the game object does not have a kinematic object.\n\n"
          "Returns:\n"
  ...
  bind_components<Armour,
                  ...
                  StatusEffects,
                  SteeringMovement,
                  Upgrades>(registry_class);
  bind_systems<ArmourRegenSystem,
               AttackSystem,
               DamageSystem,
               EffectSystem,
               FootprintSystem,
  ...
  pybind11::class_<Stat>(game_objects, "Stat", "Represents a component that has a variable value and maximum value.")
      .def(pybind11::init<double, int, bool>(),
           pybind11::arg("value"),
           pybind11::arg("maximum_level"),
  ...
  pybind11::class_<MovementForce, Stat>(game_objects,
                                        "MovementForce",
  ...
  pybind11::class_<ArmourRegenSystem, SystemBase>(systems,
                                                  "ArmourRegenSystem",
  ...
  pybind11::enum_<AttackAlgorithms>(systems,
                                    "AttackAlgorithms",
  ...
  pybind11::class_<AttackResult>(systems, "AttackResult", "Holds the result of an attack.")
      .def(pybind11::init<Vec2d, double, double>(),
           pybind11::arg("current_position"),
           pybind11::arg("x_velocity"),
  ...
  pybind11::class_<AttackSystem, SystemBase>(systems,
                                             "AttackSystem",
  ...
  pybind11::class_<StatusEffectData>(systems,
                                     "StatusEffectData",
      ...
      .def(pybind11::init<StatusEffectType, ActionFunction, ActionFunction, ActionFunction>(),
           pybind11::arg("status_effect_type"),
           pybind11::arg("increase_function"),
           pybind11::arg("duration_function"),
  ...
  pybind11::class_<EffectApplier, ComponentBase>(systems,
                                                 "EffectApplier",
      ...
      .def(pybind11::init<std::unordered_map<std::type_index, ActionFunction>,
           ...
           pybind11::arg("instant_effects"),
           pybind11::arg("status_effects"),
           (
               "Initialise the object.\n\n"
               "Args:\n"
  ...
  pybind11::class_<EffectSystem, SystemBase>(systems,
      ...
      .def("apply_instant_effect",
           &EffectSystem::apply_instant_effect,
           pybind11::arg("game_object_id"),
           pybind11::arg("target_component"),
           pybind11::arg("increase_function"),
           pybind11::arg("level"),
      ...
      .def("apply_status_effect",
           &EffectSystem::apply_status_effect,
           pybind11::arg("game_object_id"),
           pybind11::arg("target_component"),
           pybind11::arg("status_effect_data"),
           pybind11::arg("level"),
           (
  ...
  pybind11::class_<Inventory, ComponentBase>(systems,
                                             "Inventory",
  ...
  pybind11::class_<InventorySystem, SystemBase>(systems,
                                                "InventorySystem",
      ...
      .def("add_item_to_inventory",
           &InventorySystem::add_item_to_inventory,
           pybind11::arg("game_object_id"),
           pybind11::arg("item"),
           (
      ...
      .def("remove_item_from_inventory",
           &InventorySystem::remove_item_from_inventory,
           pybind11::arg("game_object_id"),
           pybind11::arg("index"),
           (
  ...
  pybind11::enum_<SteeringBehaviours>(systems,
                                      "SteeringBehaviours",
  ...
  pybind11::enum_<SteeringMovementState>(systems,
  ...
  pybind11::class_<Footprints, ComponentBase>(systems,
                                              "Footprints",
  ...
  pybind11::class_<KeyboardMovement, ComponentBase>(systems,
                                                    "KeyboardMovement",
  ...
  pybind11::class_<SteeringMovement, ComponentBase>(systems,
                                                    "SteeringMovement",
  ...
  pybind11::class_<FootprintSystem, SystemBase>(systems,
                                                "FootprintSystem",
  ...
  pybind11::class_<KeyboardMovementSystem, SystemBase>(systems,
                                                       "KeyboardMovementSystem",
      ...
      .def("calculate_keyboard_force",
           &KeyboardMovementSystem::calculate_keyboard_force,
           pybind11::arg("game_object_id"),
           (
               ...
               "Raises:\n"
               "    RegistryException: If the game object does not exist or does not have a keyboard movement component.\n\n"
               "Returns:\n"
               "    The new force to apply to the game object."
           )
      );
  pybind11::class_<SteeringMovementSystem, SystemBase>(systems,
                                                       "SteeringMovementSystem",
      ...
      .def("calculate_steering_force",
           &SteeringMovementSystem::calculate_steering_force,
           pybind11::arg("game_object_id"),
           (
               ...
               "Raises:\n"
               "    RegistryException: If the game object does not exist or does not have a steering movement component.\n\n"
               "Returns:\n"
               "    The new force to apply to the game object."
           )
      )
      .def("update_path_list",
           &SteeringMovementSystem::update_path_list,
           pybind11::arg("game_object_id"),
  ...
  pybind11::class_<UpgradeSystem, SystemBase>(systems,
                                              "UpgradeSystem",
      ...
      .def("upgrade_component",
           &UpgradeSystem::upgrade_component,
           pybind11::arg("game_object_id"),
           pybind11::arg("target_component"),
           (
...
// TODO: See if formatting can be improved here (maybe with clang-format)
