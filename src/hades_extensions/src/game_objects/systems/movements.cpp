...
// ----- STRUCTURES ------------------------------
void FootprintSystem::update(double delta_time) const {
...
Vec2d KeyboardMovementSystem::calculate_keyboard_force(GameObjectID game_object_id) const {
...
Vec2d SteeringMovementSystem::calculate_steering_force(GameObjectID game_object_id) const {
  ...
  std::uniform_int_distribution<> degree_distribution{0, MAX_DEGREE};
...
void SteeringMovementSystem::update_path_list(GameObjectID target_game_object_id,
