...
from hades_engine import EventType, GameEngine
from hades_engine.ecs import (
    SPRITE_SIZE,
    GameObjectType,
    Registry,
    RegistryError,
)
from hades_engine.ecs.systems import PhysicsSystem
...
class HadesEnvironment(Env):  # type: ignore[misc]
    ...
    def on_health_changed(
        ...
        """Handle the player's health changing."""
    ...
    def on_armour_changed(
        ...
        """Handle the player's armour changing."""
    ...
    def on_position_changed(
        ...
        """Handle the player's position changing."""
