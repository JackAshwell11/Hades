...
class GameState:
    ...
    @property
    def difficulty_level(self: GameState) -> DifficultyLevel: ...
    ...
    def set_window_size(self: GameState, width: int, height: int) -> None: ...
