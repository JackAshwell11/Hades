...
// ----- FIXTURES ------------------------------
/// Hold fixtures for the game_objects/systems/registry.cpp tests.
class RegistryFixtures : public testing::Test {
 protected:
...
TEST_F(RegistryFixtures, TestRegistryEmptyGameObject) {
...
TEST_F(RegistryFixtures, TestRegistryGameObjectComponents) {
...
TEST_F(RegistryFixtures, TestRegistryMultipleGameObjects) {
...
TEST_F(RegistryFixtures, TestRegistryGameObjectDuplicateComponents) {
  // Construct the components list
  std::vector<std::unique_ptr<ComponentBase>> components;
  components.emplace_back(create_object<TestGameObjectComponentTwo>({10}));
...
TEST_F(RegistryFixtures, TestRegistryZeroSystems) {
...
TEST_F(RegistryFixtures, TestRegistrySystemUpdate) {
...
TEST_F(RegistryFixtures, TestRegistryWalls) {
