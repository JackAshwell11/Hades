...
def test_hades_sprite_initialisation() -> None:
    ...
    sprite = HadesSprite(0, (10, 20), ["floor.png"])
...
def test_animated_sprite_multiple_textures() -> None:
    ...
    sprite = AnimatedSprite(1, (5, 10), ["wall.png", "floor.png"])
